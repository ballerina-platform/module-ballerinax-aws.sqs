...
# Represents optional parameters used to retrieve attributes of a SQS queue.
#
...
# Represents the attributes of an SQS queue. These attributes can be retrieved using the `getQueueAttributes` API.
...
# The response from the getQueueAttributes operation.
#
# + queueAttributes - field description
